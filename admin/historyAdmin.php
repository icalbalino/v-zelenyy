    ...
    <div class="d-flex vh-100">
        <div class="vh-100 side-menu-container d-flex flex-column justify-content space-between" id='side-menu'>
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="historyAdmin.php" class="list-group-item list-group-item-action list-group-item-success"><i class="fas fa-history col-2"></i>
                            ...
                            foreach ($trxes as $trx) {
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$trx['tanggal'].'</td>
                                        <td>'.$trx['total'].'</td>
                                        <td><a class="btn btn-link" href="historyAdmin.php?detail='.$trx['id'].'">Detail</a></td>
                                    </tr>
                                ';
                            }
                        ?>
